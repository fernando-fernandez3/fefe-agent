...
DEFAULT_CONFIG = {
    ...
    "memory": {
        ...
        # Additional memory provider plugin (empty = built-in only).
        # Set to a provider name to activate: "long_memory", "openviking",
        # "mem0", "hindsight", "holographic", "retaindb", "byterover".
        # Only ONE additional provider is allowed at a time.
        "provider": "",
    },
