...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("review", "Show pending AutoWorkflow review items", "Session",
               gateway_only=True, args_hint="[next]"),
    CommandDef("reject", "Reject an AutoWorkflow review item", "Session",
               gateway_only=True, args_hint="<id> [why]"),
    CommandDef("edit", "Request a redraft for an AutoWorkflow review item", "Session",
               gateway_only=True, args_hint="<id> <instruction>"),
    CommandDef("defer", "Defer an AutoWorkflow review item", "Session",
               gateway_only=True, args_hint="<id> [note]"),
    ...
    CommandDef("copilot", "Start or stop the voice copilot session", "Configuration",
    ...
    CommandDef("autonomy-seed", "Seed a default repo-health autonomy goal and policy", "Tools & Skills",
               cli_only=True),
    CommandDef("autonomy-onboard", "Onboard the current repo with a particular autonomy goal definition", "Tools & Skills",
               cli_only=True, args_hint="[goal definition]"),
    CommandDef("review-approve", "Approve a pending autonomy review and execute it", "Tools & Skills",
               args_hint="<review_id>"),
    CommandDef("review-reject", "Reject a pending autonomy review and cancel it", "Tools & Skills",
               args_hint="<review_id> [reason]"),
    CommandDef("reviews", "Show pending autonomy reviews", "Tools & Skills"),
    CommandDef("opportunities", "Show top autonomy opportunities", "Tools & Skills",
               cli_only=True),
