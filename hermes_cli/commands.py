...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("deny", "Deny a pending dangerous command", "Session",
               gateway_only=True),
    CommandDef("review-approve", "Approve a pending autonomy review", "Session",
               gateway_only=True, args_hint="<review_id>"),
    CommandDef("review-reject", "Reject a pending autonomy review", "Session",
               gateway_only=True, args_hint="<review_id> [reason]"),
